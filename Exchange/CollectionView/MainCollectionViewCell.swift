...
class MainCollectionViewCell: UICollectionViewCell {
    ...
    let labelCurensy: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.layer.zPosition = 2
        label.font = UIFont(name: "AlNile-Bold", size: 18)
    ...
    func addConstraints(){
        ...
        imageGradient.leftAnchor.constraint(equalTo: leftAnchor,constant: 20).isActive = true
        ...
        labelCurensy.topAnchor.constraint(equalTo: topAnchor,constant: 15).isActive = true
        labelCurensy.bottomAnchor.constraint(equalTo: imageGradient.centerYAnchor,constant: -5).isActive = true
        ...
        labelMoney.centerXAnchor.constraint(equalTo: centerXAnchor).isActive = true
        labelMoney.centerYAnchor.constraint(equalTo: imageGradient.centerYAnchor).isActive = true
        labelMoney.heightAnchor.constraint(equalToConstant: 30).isActive = true
        labelMoney.widthAnchor.constraint(equalToConstant: 80).isActive = true
        
        viewGraphs.topAnchor.constraint(equalTo: topAnchor,constant: 10).isActive = true
        viewGraphs.bottomAnchor.constraint(equalTo: bottomAnchor,constant: -10).isActive = true
        viewGraphs.leftAnchor.constraint(equalTo: labelMoney.rightAnchor,constant: 20).isActive = true
        viewGraphs.rightAnchor.constraint(equalTo: rightAnchor,constant: -10).isActive = true
    }
}
